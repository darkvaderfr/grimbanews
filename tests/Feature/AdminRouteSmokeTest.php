...
class AdminRouteSmokeTest extends TestCase
{
    ...
    public function test_key_grimba_admin_get_routes_render_shared_shell(): void
    {
        $routes = [
            ...
            '/admin/grimba/vault-analytics' => 'grimba-vault-week-bars',
            ...
            '/admin/grimba/cluster-review' => 'grimba-admin-table-responsive',
    ...
    public function test_admin_login_uses_minimal_guest_shell_without_admin_runtime_scripts(): void
    {
        $this->get('/admin/login')
            ...
            ->assertSee('grimba-auth-wordmark', false)
            ->assertSee('grimba-auth-visual__caption::before', false)
            ->assertSee('.grimba-auth-visual__caption h1', false)
