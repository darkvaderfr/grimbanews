...
class StoryBreakdownTest extends TestCase
{
    public function test_comparison_page_renders_bias_factuality_and_ownership_breakdown(): void
    {
        ...
        $this->get('/comparatif/' . $clusterId)
            ...
            ->assertSee('Origines', false)
            ->assertSee('Factualité', false)
            ->assertSee('Propriété', false)
            ->assertSee('Pays d’origine des sources', false)
            ->assertSee('Biais par origine', false)
            ->assertSee('Biais par pays source', false)
            ->assertSee('Amériques', false)
            ->assertSee('Camp dominant', false)
            ->assertSee('Signal de couverture', false)
            ->assertSee('grimba-breakdown__bias-intelligence', false)
            ->assertSee('grimba-breakdown__bias-spectrum', false)
            ->assertSee('grimba-breakdown__owner-grid', false)
            ->assertSee('grimba-breakdown__owner-summary-card', false)
            ->assertSee('grimba-breakdown__owner-row', false)
            ->assertSee('grimba-breakdown__origin-grid', false)
            ->assertSee('grimba-breakdown__country-bias-card', false)
