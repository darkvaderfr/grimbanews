...
3. Story page hierarchy: refine article/comparison page spacing, NobuAI insight placement, subscriber gate, and full-article readability.
4. Homepage hero readability: final contrast pass across all hero/card variants, with visual regression assertions.
