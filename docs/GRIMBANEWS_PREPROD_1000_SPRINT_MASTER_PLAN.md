...
| S1202 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1201-s1210 — Custom prompt versions v2: deferred — app/Support/GrimbaNobuAiPrompts.php (per S1074) is git-tracked; no runtime prompt-version pin (would need grimba_nobuai_prompt_version setting + per-version A/B r | deferred |
| S1203 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1201-s1210 — Hallucination detection (claim-level): deferred — needs a verifier model + ground-truth corpus. Brand-level hallucination (provider-name leak in user copy) is already locked by tests/Feature/GrimbaNob | deferred |
...
| S1208 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1201-s1210 — NobuAI model-card upload (transparency page): deferred — surrogate is the public /methodology page that describes the NobuAI stack at the brand level (no provider names per global NobuAI branding rule | deferred |
...
| S1210 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1201-s1210 — NobuAI fine-tune dataset export: deferred — would need (a) consented reader-feedback channel (S1089) and (b) JSONL export pipeline; neither shipped. | deferred |
...
| S1214 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1211-s1220 — Per-task cost attribution: deferred — every NobuAI call shares one provider chain today; no task_type column on the call ledger. | deferred |
...
| S1216 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1211-s1220 — Cost forecast v2 (rolling 7-day): deferred — needs price tables + per-call ledger. | deferred |
| S1217 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1211-s1220 — Cost anomaly detection: deferred — needs baseline + rolling-window analyzer. | deferred |
...
| S1219 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1211-s1220 — Per-tenant cost split: deferred — single-tenant today (OEM whitelabel ledger gates on S1191-S1200). | deferred |
...
| S1221 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1221-s1230 — Citation accuracy audit: deferred — needs LLM-judge harness + ground-truth corpus. | deferred |
| S1222 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1221-s1230 — Fact-check loop (auto): deferred — same. | deferred |
...
| S1224 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1221-s1230 — NobuAI fact-claim extraction: deferred — would feed S1221 + S1222. | deferred |
| S1225 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1221-s1230 — NobuAI counterargument generation: deferred — surrogate is the bias-distribution + dossier-voices partials that already surface multiple perspectives per cluster. | deferred |
...
| S1228 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1221-s1230 — NobuAI quality scoring (per summary): deferred — would need per-summary metric (semantic-coverage / faithfulness / fluency). | deferred |
| S1229 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1221-s1230 — NobuAI summary diff log: deferred — every regeneration overwrites posts.summary_nobuai; no per-version history table. | deferred |
...
| S1231 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1231-s1240 — B2B API v1 design: deferred — no /api/v1 JSON surface; RSS is the only programmatic read today. | deferred |
| S1232 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1231-s1240 — B2B API v1 auth: deferred — no Sanctum / Passport; no api_keys table. | deferred |
...
| S1234 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1231-s1240 — B2B API v1 key issuance: deferred — no key store, no key UI. | deferred |
| S1235 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1231-s1240 — B2B API v1 key rotation: deferred — same. | deferred |
| S1236 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1231-s1240 — B2B API v1 partner sandbox: deferred — no partner program. | deferred |
| S1237 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1231-s1240 — B2B API v1 IP allowlist: deferred — no per-key allowlist field. | deferred |
| S1238 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1231-s1240 — B2B API v1 webhook delivery: deferred — no outbound webhook infra. | deferred |
| S1239 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1231-s1240 — B2B API v1 changelog: deferred — docs/CHANGELOG.md is repo-internal; partner-facing changelog deferred. | deferred |
| S1240 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1231-s1240 — B2B API v1 SDK skeleton: deferred — same gate as S1231. | deferred |
| S1241 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1241-s1250 — Article endpoint: deferred — no /api/v2/articles route; Post model + GrimbaTranslationPresenter are the ready data layer. | deferred |
| S1242 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1241-s1250 — Source endpoint: deferred — NewsSource model + GrimbaSourceBreakdown ready; no route. | deferred |
| S1243 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1241-s1250 — Cluster endpoint: deferred — StoryCluster model + GrimbaDossierVoices ready; no route. | deferred |
| S1244 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1241-s1250 — Search endpoint: deferred — GrimbaSavedSearches::matchingPosts() is the ready query helper; no JSON route. | deferred |
| S1245 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1241-s1250 — Topic endpoint: deferred — GrimbaEditorialCategories::all() ready; no JSON route. | deferred |
...
| S1247 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1241-s1250 — Field-selection contract: deferred — no GraphQL / sparse-fieldsets layer. | deferred |
| S1248 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1241-s1250 — Filter / sort contract: deferred — same. | deferred |
...
| S1250 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1241-s1250 — API v2 OpenAPI spec: deferred — no spec file shipped. | deferred |
...
| S1253 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1251-s1260 — API usage dashboard: deferred — no API to dashboard. | deferred |
| S1254 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1251-s1260 — API billing meter: deferred — no Stripe / billing infra. | deferred |
| S1255 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1251-s1260 — API invoice generation: deferred — same. | deferred |
| S1256 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1251-s1260 — API quota tiers: deferred — same. | deferred |
| S1257 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1251-s1260 — API overage policy: deferred — same. | deferred |
| S1258 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1251-s1260 — API SOC2 / GDPR data export: deferred — operator-side legal + tooling pickup. | deferred |
| S1259 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1251-s1260 — API status incident comms: deferred — no status page (S1017 surrogate is /health JSON). | deferred |
| S1260 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1251-s1260 — API ops playbook: deferred — gates on S1231-S1259. | deferred |
| S1261 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1261-s1270 — Paid tier infra (Stripe install): deferred — no composer require stripe/; no stripe_ settings keys; no subscriptions migration. | deferred |
| S1262 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1261-s1270 — Subscriber tier (monthly): deferred — depends on S1261. | deferred |
| S1263 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1261-s1270 — Subscriber tier (annual): deferred — same. | deferred |
| S1264 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1261-s1270 — Family plan: deferred — same. | deferred |
| S1265 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1261-s1270 — Gift subscription: deferred — same. | deferred |
| S1266 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1261-s1270 — Subscription upgrade / downgrade: deferred — same. | deferred |
| S1267 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1261-s1270 — Subscription pause / resume: deferred — same. | deferred |
| S1268 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1261-s1270 — Cancellation flow: deferred — same. | deferred |
| S1269 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1261-s1270 — Tax / VAT compliance: deferred — operator-side accounting pickup. | deferred |
| S1270 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1261-s1270 — Subscription analytics: deferred — same gate. | deferred |
| S1271 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1271-s1280 — Header bidding (prebid.js): deferred — no prebid wrapper shipped; AdSense is single-network today. | deferred |
| S1272 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1271-s1280 — Header bidding (Amazon TAM): deferred — same. | deferred |
...
| S1275 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1271-s1280 — Programmatic deal IDs: deferred — needs SSP / DSP relationship. | deferred |
| S1276 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1271-s1280 — Floor pricing: deferred — same. | deferred |
...
| S1278 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1271-s1280 — Frequency cap per reader: deferred — no client-side cap on AdSense calls. | deferred |
| S1279 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1271-s1280 — Viewability tracking: deferred — needs viewability SDK. | deferred |
| S1280 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1271-s1280 — Ad revenue dashboard: deferred — surrogate is AdSense console. | deferred |
| S1281 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1281-s1290 — Paid newsletter tier: deferred — depends on S1261. | deferred |
| S1282 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1281-s1290 — Newsletter sponsorship slot: deferred — no general newsletter to sponsor. | deferred |
...
| S1284 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1281-s1290 — Newsletter A/B subject test: deferred — no A/B harness. | deferred |
| S1285 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1281-s1290 — Newsletter unsubscribe analytics: deferred — members.unsubscribed_at flag exists upstream in Botble; per-mail analytics deferred. | deferred |
| S1286 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1281-s1290 — Newsletter open / click tracking: deferred — no tracking pixel / link rewriter. | deferred |
...
| S1288 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1281-s1290 — Newsletter revenue share (with editors): deferred — no in-house editor program (lands with S1311+). | deferred |
...
| S1290 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1281-s1290 — Newsletter monetization playbook: deferred — gates on S1281-S1289. | deferred |
| S1291 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1291-s1300 — Daily streak counter: deferred — no members.streak_days column; no per-day visit ledger. | deferred |
| S1292 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1291-s1300 — Streak email reminder: deferred — depends on S1291. | deferred |
...
| S1296 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1291-s1300 — Reader achievement badges: deferred — no badge / gamification layer. | deferred |
| S1297 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1291-s1300 — Re-engagement email (dormant member): deferred — needs dormant-member detection + email template. | deferred |
| S1298 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1291-s1300 — In-product re-engagement nudge: deferred — partials/home/onboarding-modal.blade.php is the new-reader nudge; dormant-reader nudge deferred. | deferred |
...
| S1300 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1291-s1300 — Retention playbook: partial — docs/GRIMBANEWS_ADVERTISER_CULTURE_FRESHNESS_PLAN.md covers freshness; reader-retention playbook deferred. | partial |
| S1301 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1301-s1310 — Web push opt-in: deferred — no VAPID keys; public/grimba-sw.js does not register a push event listener. | deferred |
| S1302 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1301-s1310 — Web push server (VAPID): deferred — no webpush_subscriptions table; no web-push PHP package. | deferred |
| S1303 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1301-s1310 — Web push payload contract: deferred — same. | deferred |
| S1304 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1301-s1310 — Web push delivery worker: deferred — same. | deferred |
| S1305 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1301-s1310 — Mobile push (FCM): deferred — needs FCM project + service-account JSON. | deferred |
| S1306 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1301-s1310 — Mobile push (APNs): deferred — needs APNs auth key. | deferred |
| S1307 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1301-s1310 — Push category preferences: deferred — surrogate is per-saved-search opt-in via saved_searches.active boolean. | deferred |
| S1308 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1301-s1310 — Push frequency caps: deferred — no push infra. | deferred |
...
| S1310 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1301-s1310 — Push opt-in onboarding: deferred — same gate as S1301. | deferred |
| S1311 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1311-s1320 — In-house source editor: deferred — news_sources admin at /admin/grimba/news-sources covers source metadata; in-house "write your own article" editor deferred. | deferred |
...
| S1313 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1311-s1320 — Byline system (in-house): deferred — posts.author_type / author_id fields exist (Botble polymorphic author column, line 1294 of post.blade.php reads class_exists($post->author_type) && ...) but no in- | deferred |
...
| S1316 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1311-s1320 — Editorial calendar: deferred — operator-side editorial calendar lives outside the platform today. | deferred |
...
| S1318 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1311-s1320 — Editorial assignment system: deferred — no assignments table. | deferred |
| S1319 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1311-s1320 — Editorial style guide enforcement: deferred — operator-side editorial guide. | deferred |
...
| S1321 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1321-s1330 — Newsroom partnership doc: deferred — operator-side BD pickup. | deferred |
| S1322 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1321-s1330 — Syndication agreement template: deferred — operator-side legal pickup. | deferred |
...
| S1325 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1321-s1330 — Per-partner analytics: deferred — per-source analytics need column on grimba_vault_events or new ledger. | deferred |
| S1326 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1321-s1330 — Per-partner revenue share: deferred — gates on S1261 paid tier + S1288. | deferred |
| S1327 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1321-s1330 — Per-partner SLA: deferred — operator-side contract. | deferred |
| S1328 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1321-s1330 — Per-partner onboarding: deferred — operator-side pickup. | deferred |
| S1329 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1321-s1330 — Per-partner case study: deferred — needs partnership shipped first. | deferred |
| S1330 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1321-s1330 — Partnership program launch: deferred — gates on S1321-S1329. | deferred |
...
| S1332 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1331-s1340 — Embedding store wiring: deferred — no vector DB (per S1076). | deferred |
| S1333 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1331-s1340 — Per-article embedding generation: deferred — depends on S1332. | deferred |
| S1334 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1331-s1340 — Per-cluster embedding generation: deferred — same. | deferred |
| S1335 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1331-s1340 — Semantic-search query: deferred — same. | deferred |
| S1336 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1331-s1340 — NobuAI query expansion: deferred — no expansion layer today. | deferred |
| S1337 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1331-s1340 — Spelling correction: deferred — no fuzzy-match layer. | deferred |
| S1338 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1331-s1340 — Search-suggestion typeahead: deferred — no autocomplete endpoint. | deferred |
...
| S1340 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1331-s1340 — Search v2 launch: deferred — gates on S1332-S1339. | deferred |
...
| S1342 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1341-s1350 — Per-reader feature vector: deferred — no member_features table; cookie carries region + saved categories only. | deferred |
| S1343 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1341-s1350 — Collaborative filter (reader-similarity): deferred — needs feature vector (S1342) + similarity job. | deferred |
| S1344 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1341-s1350 — Content-based filter (article-similarity): deferred — needs embeddings (S1333). | deferred |
| S1345 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1341-s1350 — ML rank model (LR / GBDT / NN): deferred — needs training data + pipeline. | deferred |
| S1346 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1341-s1350 — A/B rank harness: deferred — no A/B engine (S1073). | deferred |
...
| S1350 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1341-s1350 — Personalization v2 launch: deferred — gates on S1341-S1349. | deferred |
| S1351 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1351-s1360 — Moderation queue: deferred — no UGC to moderate. Surrogate: /admin/grimba/rss-drafts is the editorial draft queue (operator-side approval gate for ingest output). | deferred |
| S1352 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1351-s1360 — Brigading detection: deferred — no UGC, no vote / reaction surface. | deferred |
...
| S1358 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1351-s1360 — DMCA / right-of-reply: deferred — operator-side legal pickup. | deferred |
| S1359 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1351-s1360 — Transparency report (publisher-level): deferred — operator-side annual report. | deferred |
...
| S1361 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1361-s1370 — Comment system v1 (per-article): deferred — no comments table. | deferred |
| S1362 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1361-s1370 — Comment threading: deferred — same. | deferred |
| S1363 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1361-s1370 — Comment moderation queue: deferred — same. | deferred |
| S1364 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1361-s1370 — Comment reactions (like / thoughtful): deferred — same. | deferred |
| S1365 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1361-s1370 — Comment quality scoring: deferred — same. | deferred |
| S1366 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1361-s1370 — Comment notification (per-thread): deferred — same. | deferred |
| S1367 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1361-s1370 — Comment muting / blocking: deferred — same. | deferred |
| S1368 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1361-s1370 — Comment community guidelines: deferred — operator-side editorial guidelines. | deferred |
| S1369 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1361-s1370 — Comment moderator tooling: deferred — same. | deferred |
| S1370 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1361-s1370 — Comment launch playbook: deferred — gates on S1361-S1369. | deferred |
| S1371 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1371-s1380 — Per-article annotation surface: deferred — no annotations table. | deferred |
| S1372 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1371-s1380 — Reader-side highlight (text selection → save): deferred — no client-side selection→server endpoint. | deferred |
...
| S1376 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1371-s1380 — Reader notebook: deferred — no notebook surface (cited in S1098 deferred). | deferred |
| S1377 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1371-s1380 — Per-cluster reader notes: deferred — same. | deferred |
...
| S1380 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1371-s1380 — Reader product v2 launch: deferred — gates on S1371-S1379. | deferred |
...
| S1382 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1381-s1390 — Daily report email: deferred — no grimba:daily-report-email command; vault digest + saved-search digest are the closest shipped surrogates (both weekly, not daily). | deferred |
...
| S1384 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1381-s1390 — Per-topic daily report: deferred — depends on S1382. | deferred |
...
| S1387 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1381-s1390 — Daily report A/B (subject / cover): deferred — no A/B harness. | deferred |
| S1388 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1381-s1390 — Daily report subscriber-only tier: deferred — gates on S1261. | deferred |
| S1389 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1381-s1390 — Daily report analytics: deferred — depends on S1382. | deferred |
| S1390 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1381-s1390 — Daily report launch playbook: deferred — gates on S1381-S1389. | deferred |
| S1391 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1391-s1400 — Native release pipeline (CI / fastlane): deferred — no native shell. | deferred |
| S1392 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1391-s1400 — Native signing / certificates: deferred — needs Apple Developer + Google Play Console. | deferred |
| S1393 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1391-s1400 — Native code-push / OTA updates: deferred — same. | deferred |
| S1394 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1391-s1400 — Native crash dashboard: deferred — needs Crashlytics / Sentry (S1158). | deferred |
...
| S1396 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1391-s1400 — Native deep-link verification: deferred — needs Universal Links / App Links registration (S1155). | deferred |
| S1397 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1391-s1400 — Native push-notification permission flow: deferred — needs FCM / APNs (S1154 / S1305 / S1306). | deferred |
| S1398 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1391-s1400 — Native subscription IAP (Apple / Google): deferred — gates on S1261 paid tier + Apple / Google IAP keys. | deferred |
| S1399 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1391-s1400 — Native release retrospective: deferred — gates on a real native release. | deferred |
| S1400 | docs/GRIMBANEWS_MYTHOS_S1201_S1400_NOBUAI_B2B_MONETIZATION_EVIDENCE.md#s1391-s1400 — Native app program retrospective: deferred — gates on S1391-S1399. | deferred |
| S1401 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1401-s1410 — In-house editor — seat invite + role: deferred — Botble admin auth is single-tenant with one role layer (admin / user). No editor_seats / editor_invitations table, no per-editor scoping. | deferred |
...
| S1409 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1401-s1410 — In-house editor — collaboration / co-author signoff: deferred — no multi-author workflow. | deferred |
| S1410 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1401-s1410 — In-house editor — launch retrospective: deferred — gates on S1401-S1409 actually shipping; operator-side retro. | deferred |
| S1411 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1411-s1420 — Author table schema: deferred — no authors / post_authors table; current posts model has Botble's author_id (Botble user FK) but no journalist-profile metadata. | deferred |
| S1412 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1411-s1420 — Author profile page: deferred — depends on S1411. | deferred |
...
| S1415 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1411-s1420 — Author contribution log: deferred — no author_contributions table. | deferred |
| S1416 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1411-s1420 — Author follow (reader follows author): deferred — no follow-author primitive; follow-source exists via search filters. | deferred |
| S1417 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1411-s1420 — Author RSS feed: deferred — no per-author feed route. | deferred |
| S1418 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1411-s1420 — Author analytics dashboard: deferred — no per-author view counter. | deferred |
| S1419 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1411-s1420 — Author payout integration: deferred — depends on contributor program (S1451+). | deferred |
| S1420 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1411-s1420 — Author launch retrospective: deferred — gates on S1411-S1419. | deferred |
...
| S1422 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1421-s1430 — Second-eye approval gate: deferred — no two-step approval. Surrogate is the operator manually reviewing the rss-drafts queue. | deferred |
| S1423 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1421-s1430 — Dispute escalation: deferred — operator-side editorial. | deferred |
...
| S1429 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1421-s1430 — Cross-locale dispute routing: deferred — operator-side editorial. | deferred |
| S1430 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1421-s1430 — Review-queue launch retrospective: deferred — operator-side retro. | deferred |
...
| S1433 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1431-s1440 — Correction notice — reader-facing badge: deferred — no posts.correction_notice column; surrogate is admin manual edit of posts.content. | deferred |
...
| S1435 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1431-s1440 — Cluster-level correction propagation: deferred — no per-cluster correction propagation. | deferred |
| S1436 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1431-s1440 — Translation-level correction: deferred — no per-translation correction notice. | deferred |
...
| S1438 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1431-s1440 — Correction-policy public page: deferred — no /corrections route; surrogate is /mentions-legales legal page. | deferred |
...
| S1440 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1431-s1440 — Correction-flow launch retrospective: deferred — gates on S1431-S1439. | deferred |
| S1441 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1441-s1450 — Syndication agreement template: deferred — operator-side legal pickup. | deferred |
| S1442 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1441-s1450 — Partner content-share API: deferred — no outbound API; surrogate is the per-stream RSS feeds at /feed.xml, /feed.breaking.xml, /feed.latest.xml, per-category feeds (read-only egress). | deferred |
...
| S1444 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1441-s1450 — Partner attribution report: deferred — no per-partner reporting. | deferred |
| S1445 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1441-s1450 — Partner exclusivity window: deferred — operator-side contract; no posts.exclusivity_window_until column. | deferred |
| S1446 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1441-s1450 — Partner content-takedown workflow: deferred — operator-side; surrogate is admin manual flip of posts.status to draft. | deferred |
| S1447 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1441-s1450 — Partner royalty split: deferred — depends on contributor program (S1451) + monetization (S1211). | deferred |
| S1448 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1441-s1450 — Partner brand-safety review: deferred — operator-side legal pickup. | deferred |
| S1449 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1441-s1450 — Partner case studies: deferred — needs ≥1 real partner. | deferred |
| S1450 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1441-s1450 — Partnership-program launch retrospective: deferred — gates on S1441-S1449. | deferred |
| S1451 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1451-s1460 — Contributor intake form: deferred — no contributor_applications table. | deferred |
| S1452 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1451-s1460 — Contributor profile + verification: deferred — depends on S1411 author system. | deferred |
| S1453 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1451-s1460 — Contributor rate card: deferred — operator-side. | deferred |
| S1454 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1451-s1460 — Contributor submission portal: deferred — surrogate is operator-managed /admin/grimba/rss-drafts queue. | deferred |
| S1455 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1451-s1460 — Contributor editor-handoff: deferred — depends on multi-editor workflow (S1401). | deferred |
| S1456 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1451-s1460 — Contributor payout integration (Stripe Connect / Wise): deferred — no billing infra (S1211). | deferred |
| S1457 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1451-s1460 — Contributor 1099 / tax reporting: deferred — same. | deferred |
| S1458 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1451-s1460 — Contributor analytics dashboard: deferred — depends on per-author analytics (S1418). | deferred |
| S1459 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1451-s1460 — Contributor case studies: deferred — needs ≥1 real contributor. | deferred |
| S1460 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1451-s1460 — Contributor program launch retrospective: deferred — gates on S1451-S1459. | deferred |
| S1461 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1461-s1470 — Semantic search — design doc: deferred — written design deferred; the FTS5 surface is the current substrate. | deferred |
| S1462 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1461-s1470 — Semantic search — embedding model pick: deferred — depends on S1076 embedding store (pgvector / qdrant / pinecone). | deferred |
| S1463 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1461-s1470 — Semantic search — embedding index build: deferred — same. | deferred |
| S1464 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1461-s1470 — Semantic search — query embedding: deferred — same. | deferred |
| S1465 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1461-s1470 — Semantic search — hybrid (lexical + semantic) merge: deferred — same. | deferred |
| S1466 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1461-s1470 — NobuAI query expansion (synonym / paraphrase): deferred — App\Services\GrimbaNobuAi shipped, query-expansion prompt template deferred. | deferred |
...
| S1470 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1461-s1470 — Semantic-search launch retrospective: deferred — gates on S1461-S1469. | deferred |
...
| S1475 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1471-s1480 — Search filter — by topic / category: deferred — ?category={id} filter not in current searchHandler; surrogate is /categorie/{slug} category pages. | deferred |
...
| S1489 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1481-s1490 — Saved-search digest analytics (open / click): deferred — no email-event tracking SDK (lands with newsletter v2 S1281+). | deferred |
...
| S1491 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1491-s1500 — Search-event logging schema: deferred — no search_events table. | deferred |
| S1492 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1491-s1500 — Top-searches dashboard: deferred — depends on S1491. | deferred |
| S1493 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1491-s1500 — Zero-result-search tracking: deferred — same. | deferred |
...
| S1495 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1491-s1500 — Per-source search popularity: deferred — depends on S1491. | deferred |
| S1496 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1491-s1500 — Per-bias search popularity: deferred — same. | deferred |
| S1497 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1491-s1500 — Per-date-range popularity: deferred — same. | deferred |
| S1498 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1491-s1500 — Search-result CTR: deferred — same. | deferred |
| S1499 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1491-s1500 — Search-A/B test harness: deferred — no A/B engine (per S1073 honest deferral). | deferred |
| S1500 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1491-s1500 — Search-analytics launch retrospective: deferred — gates on S1491-S1499. | deferred |
| S1501 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1501-s1510 — ML feed — design doc: deferred — written design deferred. Cookie-only pour-vous is the substrate. | deferred |
| S1502 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1501-s1510 — ML feed — collaborative filter model: deferred — needs per-member interaction matrix; current implementation is privacy-first cookie-only (no server-side per-member read log). | deferred |
| S1503 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1501-s1510 — ML feed — embedding-based recs: deferred — depends on S1076 embedding store. | deferred |
...
| S1507 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1501-s1510 — ML feed — fairness audit: deferred — depends on real ML model. | deferred |
...
| S1509 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1501-s1510 — ML feed — model A/B harness: deferred — no A/B engine (S1073). | deferred |
| S1510 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1501-s1510 — ML feed launch retrospective: deferred — gates on S1501-S1509. | deferred |
...
| S1513 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1511-s1520 — Followed topics — server-persisted: deferred — no member_followed_categories table. | deferred |
| S1514 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1511-s1520 — Blocked sources — UI: deferred — no block-source primitive. | deferred |
| S1515 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1511-s1520 — Blocked sources — server-persisted: deferred — no member_blocked_sources table. | deferred |
| S1516 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1511-s1520 — Weight slider (boost / suppress topic): deferred — depends on ML feed (S1501). | deferred |
| S1517 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1511-s1520 — Followed authors: deferred — depends on author system (S1411). | deferred |
| S1518 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1511-s1520 — Followed clusters: deferred — no follow-cluster primitive; surrogate is sharing the dossier URL. | deferred |
...
| S1520 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1511-s1520 — Preference-center launch retrospective: deferred — gates on S1511-S1519. | deferred |
...
| S1523 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1521-s1530 — Data export — saved searches (CSV / JSON): deferred — no account/saved-searches/export.csv route; surrogate is /account page list view. | deferred |
| S1524 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1521-s1530 — Data export — GDPR DSAR full bundle: deferred — depends on S1491 compliance band (GDPR DSAR pipeline). | deferred |
...
| S1529 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1521-s1530 — Privacy ops launch comms: deferred — operator-side comms. | deferred |
| S1530 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1521-s1530 — Privacy ops launch retrospective: deferred — gates on S1521-S1529. | deferred |
...
| S1538 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1531-s1540 — Echo-chamber detector: deferred — depends on per-member read log (which by design does not exist server-side). | deferred |
| S1539 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1531-s1540 — Fairness audit dashboard: deferred — no per-member ML behavior to audit yet. | deferred |
| S1540 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1531-s1540 — Fairness launch retrospective: deferred — gates on S1531-S1539. | deferred |
| S1541 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1541-s1550 — Annotation schema (highlights table): deferred — no post_annotations / post_highlights table. | deferred |
| S1542 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1541-s1550 — Highlight UI (text selection): deferred — no JS handler for text-selection highlighting. | deferred |
| S1543 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1541-s1550 — Note attached to highlight: deferred — same. | deferred |
...
| S1545 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1541-s1550 — Highlight visible to other readers (public annotations): deferred — depends on S1541. | deferred |
| S1546 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1541-s1550 — Private annotations sync across devices: deferred — same + cross-device sync. | deferred |
| S1547 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1541-s1550 — Annotation export (Markdown / Roam): deferred — depends on S1541. | deferred |
| S1548 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1541-s1550 — Annotation analytics: deferred — depends on S1541. | deferred |
| S1549 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1541-s1550 — Annotation moderation: deferred — depends on S1541. | deferred |
| S1550 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1541-s1550 — Annotation launch retrospective: deferred — gates on S1541-S1549. | deferred |
...
| S1552 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1551-s1560 — Bookmark — folders: deferred — no vault_folders column / table; flat list today. | deferred |
| S1553 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1551-s1560 — Bookmark — tags: deferred — no tag schema. | deferred |
...
| S1556 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1551-s1560 — Bookmark — search within saved: deferred — no FTS index over vault subset. | deferred |
...
| S1565 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1561-s1570 — Offline mode — conflict resolution: deferred — single-device cookie today; multi-device conflict resolution depends on cross-device sync (S1554). | deferred |
...
| S1568 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1561-s1570 — Offline mode — share-target (PWA receive shared URL): deferred — manifest share_target not registered. | deferred |
| S1569 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1561-s1570 — Offline mode — analytics (offline interaction queue): deferred — no offline-event queue. | deferred |
...
| S1571 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1571-s1580 — Reading mode — design: deferred — no ?reading=1 view variant; current article view is already content-first per partials/post-hero-img.blade.php + reading-time chip. | deferred |
...
| S1573 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1571-s1580 — Dyslexia-friendly font (OpenDyslexic / Atkinson Hyperlegible): deferred — single font stack today. | deferred |
| S1574 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1571-s1580 — Line-spacing controls: deferred — fixed line-height. | deferred |
...
| S1581 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1581-s1590 — Per-region daily digest: deferred — newsletter pipeline supports per-region routing via grimba_advertiser_leads_sales_mailbox; explicit per-region digest email template deferred. | deferred |
...
| S1584 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1581-s1590 — Time-of-day variants (morning / lunch / evening): deferred — single daily cadence today. | deferred |
...
| S1588 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1581-s1590 — Daily report — subject-line A/B: deferred — no A/B engine (S1073). | deferred |
| S1589 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1581-s1590 — Daily report — send-time A/B: deferred — same. | deferred |
| S1590 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1581-s1590 — Daily-report v2 launch retrospective: deferred — gates on S1581-S1589. | deferred |
| S1591 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1591-s1600 — Moderation queue — schema: deferred — no moderation_queue table. | deferred |
...
| S1593 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1591-s1600 — Brigading detection (anomalous traffic): deferred — no per-user behavior tracking. | deferred |
| S1594 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1591-s1600 — Downvote-spam guard: deferred — no vote primitive on reader surface. | deferred |
| S1595 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1591-s1600 — Hate-speech filter: deferred — operator-side editorial; surrogate is news_sources.factuality_score + credibility_score source-level filter on ingest. | deferred |
...
| S1597 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1591-s1600 — Author / commenter ban list: deferred — no commenter primitive. | deferred |
...
| S1599 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1591-s1600 — Trust & safety transparency report: deferred — operator-side annual report; depends on S1671 transparency band. | deferred |
| S1600 | docs/GRIMBANEWS_MYTHOS_S1401_S1600_EDITORIAL_SEARCH_PERSONALIZATION_EVIDENCE.md#s1591-s1600 — Trust & safety launch retrospective: deferred — gates on S1591-S1599. | deferred |
| S2001 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2001-s2020 — Annual transparency report — scope definition: deferred — scaffold per Mythos honesty note; needs editorial-owner + counsel + Vader scope sign-off | deferred |
| S2002 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2001-s2020 — Annual transparency report — moderation-action counts: deferred — gates on S1591 moderation_queue; surrogate is grimba_automation_runs | deferred |
| S2003 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2001-s2020 — Annual transparency report — takedown / DMCA counts: deferred — no takedown intake; needs mailto:legal alias + operator log | deferred |
| S2004 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2001-s2020 — Annual transparency report — government / LE data requests: deferred — no LE-request intake; needs counsel-defined per-jurisdiction workflow | deferred |
| S2005 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2001-s2020 — Annual transparency report — source-license challenges + outcomes: deferred — news_sources.license_notes is the operator slot (S1030); aggregation surface deferred | deferred |
| S2006 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2001-s2020 — Annual transparency report — corrections issued + per-source count: deferred — no corrections primitive; gates on corrections table + editorial workflow S1291 | deferred |
| S2007 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2001-s2020 — Annual transparency report — ad rejections + per-category breakdown: deferred — GrimbaAds consent hooks exist (S871) but no rejection log + annual aggregation | deferred |
...
| S2009 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2001-s2020 — Annual transparency report — A/B-test outcomes transparency: deferred — no A/B engine wired (S1073) | deferred |
| S2010 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2001-s2020 — Annual transparency report — methodology change log per-year: deferred — internal change log is git history; public versioning surface deferred | deferred |
| S2011 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2001-s2020 — Annual transparency report — publish cadence: deferred — needs >=1 full operational year + editorial-owner pickup | deferred |
| S2012 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2001-s2020 — Annual transparency report — multi-locale publication: deferred — gates on S2011 + per-locale catalogs (S1101+) | deferred |
| S2013 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2001-s2020 — Annual transparency report — open-data download bundle (CSV / JSON): deferred — surrogate is coffre/export.csv subscriber export; transparency-data export deferred | deferred |
| S2014 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2001-s2020 — Annual transparency report — third-party audit attestation: deferred — needs external auditor engagement; zero contracts today | deferred |
| S2015 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2001-s2020 — Annual transparency report — comparison to peer outlets: deferred — operator-side editorial framing | deferred |
| S2016 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2001-s2020 — Annual transparency report — press coverage of the report itself: deferred — gates on S2011 first edition | deferred |
| S2017 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2001-s2020 — Annual transparency report — reader feedback intake: deferred — no feedback intake surface; needs /transparency/feedback form | deferred |
...
| S2025 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2021-s2040 — Ombudsman intake — anonymous tip channel: deferred — needs SecureDrop or equivalent; zero anonymous-tip infra today | deferred |
| S2026 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2021-s2040 — Complaint triage workflow — severity rubric: deferred — needs ombudsman + editorial-board co-authored rubric | deferred |
| S2027 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2021-s2040 — Complaint triage workflow — investigation log (internal): deferred — no log table; needs ombudsman_investigations schema | deferred |
| S2028 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2021-s2040 — Complaint workflow — response SLA (14d initial / 60d close): deferred — operator-side SLA contract | deferred |
| S2029 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2021-s2040 — Complaint workflow — public findings publication: deferred — gates on S2023 + editorial-policy on public-vs-private findings | deferred |
| S2030 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2021-s2040 — Complaint workflow — anonymized-but-public log: deferred — gates on S2029 | deferred |
| S2031 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2021-s2040 — Ombudsman — annual report (separate from S2001): deferred — separate cadence; ombudsman reports to readers, not to operator | deferred |
| S2032 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2021-s2040 — Ombudsman — cross-locale intake (FR + EN today, more post-S1101): deferred — gates on S2023 + per-locale catalogs | deferred |
| S2033 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2021-s2040 — Ombudsman — escalation to external press council: deferred — needs counsel-defined per-jurisdiction routing | deferred |
| S2034 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2021-s2040 — Ombudsman — correction-issuance authority: deferred — needs charter clause (S2021) + corrections primitive (S2006) | deferred |
| S2035 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2021-s2040 — Ombudsman — staff-training / case-study program: deferred — operator-side editorial training | deferred |
| S2036 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2021-s2040 — Ombudsman — reader-rights education page (/vos-droits): deferred — no such page today; needs counsel review per jurisdiction | deferred |
| S2037 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2021-s2040 — Ombudsman — quarterly office-hours (public): deferred — operator-side cadence; not viable solo | deferred |
...
| S2045 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2041-s2060 — Methodology repo — factuality-score rubric extraction: deferred — same; from news_sources.factuality_score + ingest filter | deferred |
| S2046 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2041-s2060 — Methodology repo — ownership-classification rules: deferred — same; from news_sources.ownership_type enum + classifier | deferred |
| S2047 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2041-s2060 — Methodology repo — cluster-merge algorithm: deferred — same; from GrimbaRssPoller::findOrFormCluster() | deferred |
| S2048 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2041-s2060 — Methodology repo — dedup rules: deferred — same; from GrimbaArticleDedupe + canonical URL + title similarity | deferred |
| S2049 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2041-s2060 — Methodology repo — translation-rule engine: deferred — same; from GrimbaTranslationRules + daily_cap setting | deferred |
| S2050 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2041-s2060 — Methodology repo — README + getting-started guide: deferred — gates on S2041 scope decision | deferred |
| S2051 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2041-s2060 — Methodology repo — CONTRIBUTING.md + code of conduct: deferred — needs community-manager owner; not hired | deferred |
| S2052 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2041-s2060 — Methodology repo — versioning policy (semver vs date-based): deferred — gates on S2041 | deferred |
| S2053 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2041-s2060 — Methodology repo — DOI registration for citable methodology: deferred — needs Zenodo / Figshare account | deferred |
| S2054 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2041-s2060 — Methodology repo — academic-paper companion: deferred — operator-side academic output; needs PI + funding | deferred |
| S2055 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2041-s2060 — Methodology repo — translation of repo (FR + EN minimum): deferred — gates on S2050 | deferred |
| S2056 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2041-s2060 — Methodology repo — issue-triage workflow: deferred — gates on S2043 + community-manager hire | deferred |
| S2057 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2041-s2060 — Methodology repo — PR-review workflow: deferred — same | deferred |
| S2058 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2041-s2060 — Methodology repo — release cadence (quarterly vs ad-hoc): deferred — gates on S2041 | deferred |
| S2059 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2041-s2060 — Methodology repo — sponsorship / GitHub Sponsors integration: deferred — gates on S2043 + Stripe Atlas / SponsorLink | deferred |
| S2060 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2041-s2060 — Methodology repo — launch retrospective: deferred — gates on S2041-S2059 | deferred |
| S2061 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2061-s2080 — Translator OSS release — repo scaffolding: deferred — Laravel-coupled; needs framework-neutral port | deferred |
| S2062 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2061-s2080 — Translator OSS release — NobuAI / OpenRouter / LibreTranslate driver split: deferred — needs per-driver-package separation + each license-cleared independently | deferred |
| S2063 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2061-s2080 — Translator OSS release — rule-engine OSS: deferred — needs scope decision (S2041); from GrimbaTranslationRules | deferred |
| S2064 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2061-s2080 — Translator OSS release — quality-eval harness: deferred — no eval harness exists internally; would need build before release | deferred |
| S2065 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2061-s2080 — Translator OSS release — example apps / cookbook: deferred — gates on S2061 | deferred |
| S2066 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2061-s2080 — Detector OSS release — n-gram corpus extraction: deferred — corpus is embedded constants in GrimbaLanguageDetector; needs export tooling + license-cleared upstream | deferred |
| S2067 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2061-s2080 — Detector OSS release — TLD heuristic table: deferred — small enough to embed; gates on S2066 | deferred |
...
| S2069 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2061-s2080 — Detector OSS release — Python / JS / Rust port: deferred — PHP-only today; needs polyglot maintainers | deferred |
| S2070 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2061-s2080 — Detector OSS release — benchmark page vs cld3 / fastText: deferred — no benchmark harness today | deferred |
| S2071 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2061-s2080 — Cluster engine OSS release — algorithm extraction: deferred — tightly coupled to posts table + Laravel ORM; needs schema-neutral port | deferred |
...
| S2073 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2061-s2080 — Cluster engine OSS release — title-similarity threshold tuning guide: deferred — needs published guide + tuning fixtures | deferred |
| S2074 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2061-s2080 — Cluster engine OSS release — orphan-cluster cleanup pattern: deferred — Laravel-coupled; needs schema-neutral port | deferred |
| S2075 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2061-s2080 — Cluster engine OSS release — bias-diversity scoring: deferred — needs framework-neutral port + license-clear from GrimbaSourceBreakdown | deferred |
| S2076 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2061-s2080 — Cluster engine OSS release — confidence-score model: deferred — rule-based today (S1053); needs export tooling | deferred |
| S2077 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2061-s2080 — Cluster engine OSS release — example datasets: deferred — would need contributor-cleared real corpus or synthetic generator | deferred |
| S2078 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2061-s2080 — Cluster engine OSS release — academic citation guide: deferred — gates on S2053 DOI | deferred |
| S2079 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2061-s2080 — Cluster engine OSS release — community fork tracker: deferred — gates on S2043 + community-manager | deferred |
| S2080 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2061-s2080 — Translator+detector+cluster OSS — joint launch retrospective: deferred — gates on S2061-S2079 | deferred |
| S2081 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2081-s2100 — Community — code of conduct (Contributor Covenant 2.1): deferred — no public repo today | deferred |
| S2082 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2081-s2100 — Community — DCO (Developer Certificate of Origin) bot: deferred — same | deferred |
| S2083 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2081-s2100 — Community — CLA or DCO-only decision: deferred — needs counsel | deferred |
| S2084 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2081-s2100 — Community — triage rotation roster: deferred — needs community-manager owner + >=3 maintainers | deferred |
| S2085 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2081-s2100 — Community — PR-review SLA (first-response in 7 days): deferred — operator-side SLA | deferred |
| S2086 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2081-s2100 — Community — contributor-onboarding doc: deferred — needs CONTRIBUTING.md (S2051) + GOOD-FIRST-ISSUE labels | deferred |
| S2087 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2081-s2100 — Community — recognition program (CONTRIBUTORS.md + monthly shout-outs): deferred — gates on S2043 | deferred |
| S2088 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2081-s2100 — Community — mentorship program: deferred — needs sustained community-manager bandwidth | deferred |
| S2089 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2081-s2100 — Community — quarterly community call: deferred — operator-side cadence | deferred |
| S2090 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2081-s2100 — Community — Discord / Matrix / Slack channel: deferred — needs channel provisioning + moderator roster | deferred |
| S2091 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2081-s2100 — Community — bug-bounty program: deferred — overlaps S2011-S2020 security band; needs HackerOne / YesWeHack account | deferred |
...
| S2093 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2081-s2100 — Community — sponsor-recognition page (Open Collective / GitHub Sponsors): deferred — gates on S2059 | deferred |
| S2094 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2081-s2100 — Community — i18n translation contribution flow (Crowdin / Weblate): deferred — would streamline S1101+ i18n; not provisioned | deferred |
| S2095 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2081-s2100 — Community — fork-friendly architecture decision records (ADRs): deferred — internal ADRs do not exist as a public-facing series | deferred |
| S2096 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2081-s2100 — Community — academic-partnership intake: deferred — operator-side academic outreach | deferred |
| S2097 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2081-s2100 — Community — press / journalist intake (case studies): deferred — operator-side press relations | deferred |
| S2098 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2081-s2100 — Community — annual community survey: deferred — gates on S2043 + >=1 year of contributors | deferred |
| S2099 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2081-s2100 — Community — anti-harassment escalation path (CoC enforcement): deferred — needs CoC committee (>=3 people) | deferred |
| S2100 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2081-s2100 — Community — flow launch retrospective: deferred — gates on S2081-S2099 | deferred |
| S2101 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2101-s2120 — Schools program — scope decision + first-pilot region: deferred — needs partnership-program owner (not hired) | deferred |
| S2102 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2101-s2120 — Schools program — curriculum draft (media literacy + bias): deferred — needs pedagogy partner | deferred |
| S2103 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2101-s2120 — Schools program — per-school login flow (LMS SSO): deferred — single-tenant auth today | deferred |
| S2104 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2101-s2120 — Schools program — teacher dashboard: deferred — no LMS surface | deferred |
| S2105 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2101-s2120 — Schools program — student-data privacy review (COPPA / GDPR-K / Quebec Law 25): deferred — needs counsel per jurisdiction | deferred |
| S2106 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2101-s2120 — Schools program — age-appropriate content filter: deferred — current source roster has no per-source age-rating | deferred |
| S2107 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2101-s2120 — Schools program — French-curriculum alignment (Education nationale): deferred — operator-side pedagogy mapping | deferred |
| S2108 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2101-s2120 — Schools program — Canadian-curriculum alignment (per-province): deferred — same | deferred |
| S2109 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2101-s2120 — Schools program — US-curriculum alignment (Common Core + NAMLE): deferred — same | deferred |
| S2110 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2101-s2120 — Schools program — IB / Cambridge alignment: deferred — same | deferred |
| S2111 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2101-s2120 — Schools program — teacher-training workshops: deferred — needs trainer roster + travel budget | deferred |
| S2112 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2101-s2120 — Schools program — student-essay corpus (anonymized + published): deferred — needs IRB-equivalent review | deferred |
| S2113 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2101-s2120 — Schools program — annual student-essay contest: deferred — operator-side editorial | deferred |
| S2114 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2101-s2120 — Schools program — alumni network: deferred — gates on >=1 year of student cohorts | deferred |
| S2115 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2101-s2120 — Schools program — pricing decision (free for schools?): deferred — needs Ray unit-economics review | deferred |
| S2116 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2101-s2120 — Schools program — case studies (per-school): deferred — gates on S2101 first partnership | deferred |
| S2117 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2101-s2120 — Schools program — research-paper coauthorship with partner schools: deferred — operator-side academic output | deferred |
| S2118 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2101-s2120 — Schools program — accessibility for special-needs classrooms: deferred — needs A11y v3 (per S1571-S1580 deferred set) | deferred |
| S2119 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2101-s2120 — Schools program — multilingual deployment: deferred — gates on S1101+ catalogs | deferred |
| S2120 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2101-s2120 — Schools program — launch retrospective: deferred — gates on S2101-S2119 + >=1 academic year | deferred |
| S2121 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2121-s2140 — Adult-ed program — scope decision + first-pilot region: deferred — needs partnership-program owner | deferred |
| S2122 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2121-s2140 — Adult-ed program — curriculum draft: deferred — needs adult-pedagogy partner | deferred |
| S2123 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2121-s2140 — Adult-ed program — public-library partnership (BAnQ / NYPL): deferred — operator-side outreach | deferred |
| S2124 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2121-s2140 — Adult-ed program — community-center partnership (YMCA / Maison de quartier): deferred — same | deferred |
| S2125 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2121-s2140 — Adult-ed program — citizenship-prep partnership: deferred — same; FR naturalisation / Canada citizenship-test / US USCIS | deferred |
| S2126 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2121-s2140 — Adult-ed program — ESL / FSL classroom integration: deferred — surrogate is FR <-> EN parity per S301; per-curriculum integration deferred | deferred |
| S2127 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2121-s2140 — Adult-ed program — print-handout assets (offline-classroom): deferred — no print-CSS layout shipped | deferred |
| S2128 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2121-s2140 — Adult-ed program — facilitator-training workshops: deferred — needs trainer roster | deferred |
| S2129 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2121-s2140 — Adult-ed program — accessibility for low-literacy learners (audio mode): deferred — no TTS layer | deferred |
| S2130 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2121-s2140 — Adult-ed program — pricing decision (free for libraries?): deferred — needs Ray review | deferred |
| S2131 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2121-s2140 — Adult-ed program — per-program enrollment flow: deferred — single-tenant auth today | deferred |
| S2132 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2121-s2140 — Adult-ed program — case studies: deferred — gates on S2121 first partnership | deferred |
| S2133 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2121-s2140 — Adult-ed program — diaspora-community partnership: deferred — overlaps Afrique-edition editorial focus | deferred |
...
| S2135 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2121-s2140 — Adult-ed program — multilingual deployment: deferred — gates on S1101+ catalogs | deferred |
...
| S2137 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2121-s2140 — Adult-ed program — group-progress dashboard (facilitator surface): deferred — no LMS surface | deferred |
| S2138 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2121-s2140 — Adult-ed program — feedback intake from learners: deferred — no feedback surface today | deferred |
| S2139 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2121-s2140 — Adult-ed program — alumni-mentorship channel: deferred — operator-side community | deferred |
| S2140 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2121-s2140 — Adult-ed program — launch retrospective: deferred — gates on S2121-S2139 | deferred |
| S2141 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2141-s2160 — Civic-NGO program — scope decision: deferred — scaffold per Mythos honesty note; needs Lucy + Vader scope decision | deferred |
| S2142 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2141-s2160 — RSF (Reporters Without Borders) partnership intake: deferred — no outreach | deferred |
| S2143 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2141-s2160 — Conseil de deontologie journalistique partnership: deferred — same | deferred |
| S2144 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2141-s2160 — Trust Project trust-indicator adoption: deferred — 8 trust indicators not implemented as machine-readable schema | deferred |
| S2145 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2141-s2160 — NewsGuard rating-engagement: deferred — external rating service; engagement is operator-side | deferred |
| S2146 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2141-s2160 — AllSides bias-rating cross-validation: deferred — cross-validation harness deferred | deferred |
| S2147 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2141-s2160 — Medias en Seine / academic-conference participation: deferred — operator-side presence | deferred |
| S2148 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2141-s2160 — IFCN (International Fact-Checking Network) signatory pursuit: deferred — needs Code of Principles compliance audit; not started | deferred |
| S2149 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2141-s2160 — JournalismAI / Polis-LSE research partnership: deferred — operator-side academic outreach | deferred |
| S2150 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2141-s2160 — Knight Foundation / Craig Newmark Philanthropies grant pursuit: deferred — operator-side fundraising | deferred |
| S2151 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2141-s2160 — Civil-society advocacy coalition (electoral integrity): deferred — operator-side | deferred |
| S2152 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2141-s2160 — NGO data-license agreements: deferred — needs S1181 public API v2 | deferred |
| S2153 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2141-s2160 — Coverage of NGO-published reports (editorial commitment): deferred — operator-side editorial | deferred |
| S2154 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2141-s2160 — Joint events with NGO partners: deferred — gates on first partnership | deferred |
| S2155 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2141-s2160 — Joint research publications: deferred — gates on S2149 academic partnership | deferred |
| S2156 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2141-s2160 — Civic-NGO case studies (per-partner): deferred — gates on S2141 first | deferred |
| S2157 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2141-s2160 — Cross-locale NGO partnerships (per-region): deferred — gates on S2141 | deferred |
| S2158 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2141-s2160 — Annual civic-NGO partner summit: deferred — operator-side cadence | deferred |
| S2159 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2141-s2160 — Renewal / retention metrics (per-partner): deferred — gates on partnerships existing | deferred |
| S2160 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2141-s2160 — Civic-NGO launch retrospective: deferred — gates on S2141-S2159 | deferred |
| S2161 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2161-s2180 — DOM-TOM source-roster expansion — scope: deferred — operator-side editorial pickup; surrogate is RssFeedsSeeder + grimba:classify-sources cron | deferred |
| S2162 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2161-s2180 — Guadeloupe / Martinique sources (RCI / Outremers360 / France Antilles): deferred — needs feed-URL research + license review | deferred |
| S2163 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2161-s2180 — Guyane sources (Guyane la 1ere / France-Guyane): deferred — same | deferred |
| S2164 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2161-s2180 — Mayotte / Reunion sources (Mayotte la 1ere / Linfo.re / Clicanoo): deferred — same | deferred |
| S2165 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2161-s2180 — Polynesie / Nouvelle-Caledonie / Wallis-et-Futuna sources: deferred — same | deferred |
| S2166 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2161-s2180 — Saint-Pierre-et-Miquelon / Saint-Barthelemy / Saint-Martin sources: deferred — same | deferred |
| S2167 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2161-s2180 — Pacific islands sources — Fiji / Samoa / Tonga / Vanuatu: deferred — same | deferred |
| S2168 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2161-s2180 — Pacific islands sources — Solomon Islands / Papua New Guinea: deferred — same | deferred |
| S2169 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2161-s2180 — Cabo Verde / Sao Tome / Comoros sources: deferred — same | deferred |
| S2170 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2161-s2180 — Lesotho / eSwatini / Eritrea / Djibouti / Burundi sources: deferred — same | deferred |
...
| S2172 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2161-s2180 — Per-region NobuAI prompt tuning (local context): deferred — single global prompt today (S1082) | deferred |
| S2173 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2161-s2180 — Per-region credibility-score baseline: deferred — needs operator-side editorial calibration per region | deferred |
| S2174 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2161-s2180 — Per-region editorial-policy review: deferred — operator-side | deferred |
| S2175 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2161-s2180 — Per-region launch comms: deferred — gates on S2161-S2173 | deferred |
| S2176 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2161-s2180 — Per-region reader-feedback intake: deferred — no feedback surface today | deferred |
| S2177 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2161-s2180 — Per-region partnership with local newsrooms: deferred — operator-side editorial outreach | deferred |
| S2178 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2161-s2180 — Per-region under-covered-story tracker: deferred — needs editorial-workflow S1291 | deferred |
| S2179 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2161-s2180 — Per-region annual coverage-density report: deferred — gates on S2001 transparency report + per-region counters | deferred |
| S2180 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2161-s2180 — Under-covered-region program launch retrospective: deferred — gates on S2161-S2179 | deferred |
| S2181 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2181-s2200 — Niche-topic v2 — scope decision: deferred — operator-side editorial | deferred |
| S2182 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2181-s2200 — Climate v2 — deep source-roster (Carbon Brief / Reporterre / Mongabay): deferred — operator-side pickup; surrogate is grimba:seed-thin-category-sources (S1024) | deferred |
| S2183 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2181-s2200 — Climate v2 — per-COP coverage program: deferred — operator-side editorial commitment | deferred |
| S2184 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2181-s2200 — Climate v2 — methodology coverage (science vs policy explainer): deferred — operator-side editorial | deferred |
| S2185 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2181-s2200 — Climate v2 — IPCC-report coverage playbook: deferred — operator-side | deferred |
| S2186 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2181-s2200 — Science v2 — preprint-server integration (arXiv / bioRxiv / medRxiv): deferred — needs ingest adapter; not RSS-native | deferred |
| S2187 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2181-s2200 — Science v2 — peer-reviewed-journal coverage (Nature / Science / Lancet): deferred — operator-side editorial | deferred |
...
| S2205 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2201-s2220 — Long-form investigations — data-analysis pipeline (CSV / Pandas / DuckDB): deferred — operator-side tooling | deferred |
| S2206 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2201-s2220 — Long-form investigations — collaborative editing surface: deferred — operator-side | deferred |
| S2207 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2201-s2220 — Long-form investigations — fact-check workflow (per-investigation): deferred — overlaps S2148 IFCN signatory pursuit | deferred |
| S2208 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2201-s2220 — Long-form investigations — counsel review per-investigation: deferred — needs retained press counsel | deferred |
| S2209 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2201-s2220 — Long-form investigations — long-form layout template (>3000 words): deferred — current article layout is standard reader (partials/post-hero-img.blade.php) | deferred |
...
| S2211 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2201-s2220 — Long-form investigations — companion data publication: deferred — overlaps S2013 transparency-data export | deferred |
| S2212 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2201-s2220 — Long-form investigations — companion podcast / video: deferred — no podcast / video pipeline | deferred |
| S2213 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2201-s2220 — Long-form investigations — press-release distribution to peer outlets: deferred — operator-side comms | deferred |
| S2214 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2201-s2220 — Long-form investigations — awards-submission cadence: deferred — operator-side recognition; Pulitzer / Albert-Londres / European Press Prize | deferred |
| S2215 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2201-s2220 — Long-form investigations — reader-impact tracking: deferred — needs GrimbaVaultEvents extension + outcome-log column | deferred |
| S2216 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2201-s2220 — Long-form investigations — investigation-archive (separate from regular): deferred — gates on first investigation | deferred |
| S2217 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2201-s2220 — Long-form investigations — collaborative investigations with peer outlets (ICIJ-style): deferred — operator-side editorial partnerships | deferred |
| S2218 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2201-s2220 — Long-form investigations — pricing decision (premium tier? free?): deferred — gates on S1211 monetization | deferred |
| S2219 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2201-s2220 — Long-form investigations — annual investigations review: deferred — gates on >=1 year of investigations | deferred |
| S2220 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2201-s2220 — Long-form investigations launch retrospective: deferred — gates on S2201-S2219 | deferred |
| S2221 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2221-s2237 — Multi-decade preservation — scope decision + retention horizon: deferred — needs Vader + counsel + Ray cost review; scaffold per Mythos honesty note | deferred |
| S2222 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2221-s2237 — Multi-decade preservation — Internet Archive Wayback partnership: deferred — free service; needs operator-side SPN submission cadence | deferred |
| S2223 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2221-s2237 — Multi-decade preservation — IIPC membership: deferred — paid membership; needs Ray review | deferred |
| S2224 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2221-s2237 — Multi-decade preservation — BnF / BAnQ legal-deposit registration: deferred — legal-deposit is mandatory for FR publishers above a threshold; needs counsel | deferred |
| S2225 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2221-s2237 — Multi-decade preservation — Library of Congress NDIIPP registration: deferred — operator-side outreach | deferred |
...
| S2229 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2221-s2237 — Archive cadence — image-asset preservation (per-article hero images): deferred — current image-storage policy retains hero URLs but not local copies | deferred |
| S2230 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2221-s2237 — Archive cadence — translation-archive (per-article translation history): deferred — current schema overwrites translations; per-version history deferred | deferred |
| S2231 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2221-s2237 — Iboga-wide reconciliation (cross-product preservation policy alignment): deferred — operator-side Iboga Ventures governance; needs Sara Chen + Larry Ellison | deferred |
| S2232 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2221-s2237 — GrimbaNews maturity audit (post-Mythos full-stack audit): deferred — gates on prod >=2 years uptime + S2051 audit-readiness band | deferred |
| S2233 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2221-s2237 — GrimbaNews exit / expansion criteria: deferred — operator-side strategic decision; needs Vader + Lucy | deferred |
| S2234 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2221-s2237 — GrimbaNews 5-year vision update (post-Mythos refresh): deferred — gates on >=5 years operational data | deferred |
| S2235 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2221-s2237 — GrimbaNews founder retrospective (Vader written reflection): deferred — operator-side founder pickup; cannot generate | deferred |
| S2236 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2221-s2237 — GrimbaNews Mythos master fleet final closure: deferred — gates on S2237; meta-row that closes the Mythos arc itself | deferred |
| S2237 | docs/GRIMBANEWS_MYTHOS_S2001_S2237_TRUST_OPENSOURCE_FINAL_EVIDENCE.md#s2221-s2237 — GrimbaNews S2237 ledger signoff: deferred — gates on S2236 + Zen / Echo / Mnemo audit panel + Vader written signoff | deferred |
...
| S1608 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1601-s1610 — Per-city dedicated landing copy / editorial brief: deferred — no local_cities table, no per-city brief CMS; the single /local view shares one heading template. | deferred |
| S1609 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1601-s1610 — Per-city sponsor / advertiser slot: deferred — app/Support/GrimbaAds.php ships single global ad slot; per-city ad-targeting deferred. | deferred |
| S1610 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1601-s1610 — Per-city launch playbook: deferred — operator-side editorial playbook; gates on S1601 + S1608 + S1609. | deferred |
| S1611 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1611-s1620 — City taxonomy schema: deferred — no local_cities table; only news_sources.city slot exists at the source level. | deferred |
| S1612 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1611-s1620 — City taxonomy admin UI: deferred — depends on S1611. | deferred |
...
| S1616 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1611-s1620 — Local source priority admin: deferred — depends on S1615; operator surrogate is /admin/grimba/news-sources for direct edit. | deferred |
...
| S1620 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1611-s1620 — Local v2 admin launch playbook: deferred — gates on S1611-S1619; operator-side editorial playbook. | deferred |
...
| S1622 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1621-s1630 — France pilot — DOM-TOM editorial bucket: deferred — no separate editorial_region='dom-tom'; surrogate is France-Guyane source pinned country='FR' per GrimbaSourceClassifier. DOM-TOM-specific landing d | deferred |
...
| S1624 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1621-s1630 — France pilot — language variant (FR vs FR-Canadian): deferred — posts.original_language='fr' is single-bucket; FR-CA detection deferred per GrimbaLanguageDetector (covers FR but not FR-CA dialect). | deferred |
...
| S1630 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1621-s1630 — France pilot launch retrospective: deferred — operator-side retro; gates on S1622-S1625 DOM-TOM coverage. | deferred |
...
| S1634 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1631-s1640 — Africa pilot — lusophone Africa source pool: deferred — Angola / Mozambique / Cabo Verde / Guiné-Bissau PT-language sources not seeded; posts.original_language='pt' detector covers per GrimbaLanguageD | deferred |
...
| S1636 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1631-s1640 — Africa pilot — swahili / arabic source pool: deferred — Swahili (sw) detector path + lang/sw.json deferred per S1139; Arabic (ar) covers North Africa but lang/ar.json + RTL chrome deferred per S1132 + | deferred |
...
| S1640 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1631-s1640 — Africa pilot launch retrospective: deferred — operator-side editorial retro; gates on S1632-S1638. | deferred |
...
| S1643 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1641-s1650 — UK pilot — UK-edition newsletter: deferred — newsletter_subscriptions table has no per-edition column; surrogate is bias_signal segmentation. | deferred |
...
| S1646 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1641-s1650 — US pilot — US-edition newsletter: deferred — same shape as S1643. | deferred |
...
| S1649 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1641-s1650 — Canada pilot — Quebec / FR-CA dialect handling: deferred — GrimbaLanguageDetector returns 'fr' for both FR-FR and FR-CA; per-dialect routing deferred. | deferred |
| S1650 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1641-s1650 — UK / US / Canada pilot launch retrospective: deferred — operator-side editorial retro. | deferred |
| S1651 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1651-s1660 — Embed widget — /embed/{cluster-id} route: deferred — no embed route shipped. | deferred |
| S1652 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1651-s1660 — Embed widget — iframe-friendly stripped chrome layout: deferred — no embed.blade.php layout; grimba-chrome.blade.php ships full nav. | deferred |
| S1653 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1651-s1660 — Embed widget — JS-snippet generator (<script src="grimbanews.com/embed.js?cluster=…">): deferred — no embed.js bundle. | deferred |
| S1654 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1651-s1660 — Embed widget — embed-token API (rate-limit per publisher): deferred — no embed_tokens table; no public API yet (per S1181-S1190). | deferred |
| S1655 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1651-s1660 — Embed widget — embed CSS isolation (Shadow DOM or scoped CSS): deferred — depends on S1653. | deferred |
| S1656 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1651-s1660 — Embed widget — embed analytics (per-embed impressions): deferred — no embed_impressions table. | deferred |
| S1657 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1651-s1660 — Embed widget — embed click-through tracking: deferred — same. | deferred |
| S1658 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1651-s1660 — Embed widget — embed branding ("Powered by NobuAI / GrimbaNews"): deferred — depends on S1653; brand-purity locked by GrimbaNobuAiBrandPurityTest (user-facing copy says "NobuAI" never "Anthropic" / "C | deferred |
| S1659 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1651-s1660 — Embed widget — embed responsive sizing: deferred — depends on S1653. | deferred |
| S1660 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1651-s1660 — Embed widget — embed launch playbook: deferred — gates on S1651-S1659. | deferred |
| S1661 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1661-s1670 — Bias chart embed — /embed/bias-chart/{cluster-id} route: deferred — same root reason as S1651. | deferred |
...
| S1664 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1661-s1670 — Bias chart embed — SVG export: deferred — current chart is HTML+CSS, not exported SVG. | deferred |
| S1665 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1661-s1670 — Bias chart embed — PNG export: deferred — would need server-side HTML→PNG rasterizer (not provisioned). | deferred |
| S1666 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1661-s1670 — Bias chart embed — embed parameters (?style=compact\|wide): deferred — depends on S1661. | deferred |
| S1667 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1661-s1670 — Bias chart embed — embed click-through ("see full dossier on GrimbaNews"): deferred — depends on S1661. | deferred |
...
| S1669 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1661-s1670 — Bias chart embed — embed bot-detection (no headless-Chrome scraping): deferred — would gate on S1654 token system. | deferred |
| S1670 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1661-s1670 — Bias chart embed — launch playbook: deferred — gates on S1661-S1669. | deferred |
| S1671 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1671-s1680 — Classroom — /classroom route: deferred — no classroom route. | deferred |
...
| S1674 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1671-s1680 — Classroom — teacher-account schema: deferred — no educator_seats / classrooms / students tables; Botble member auth single-role. | deferred |
...
| S1677 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1671-s1680 — Classroom — student progress dashboard: deferred — no student_reads table. | deferred |
| S1678 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1671-s1680 — Classroom — assignment primitive: deferred — no assignments table. | deferred |
| S1679 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1671-s1680 — Classroom — teacher discount tier: deferred — no paid tier (lands with S1211). | deferred |
| S1680 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1671-s1680 — Classroom — launch playbook: deferred — gates on S1671-S1679. | deferred |
...
| S1682 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1681-s1690 — Dataset — per-cluster CSV export: deferred — no /datasets/clusters.csv endpoint; surrogate is per-cluster /dossier/{id} API-shape JSON via seo-meta-config.blade.php. | deferred |
| S1683 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1681-s1690 — Dataset — per-day CSV export: deferred — no /datasets/daily.csv endpoint. | deferred |
...
| S1687 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1681-s1690 — Dataset — dataset license / terms-of-use page: deferred — no /datasets/license page; surrogate is /methodologie (open + revisable). | deferred |
| S1688 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1681-s1690 — Dataset — dataset citation guidance: deferred — depends on S1687 + paper review (S1718). | deferred |
| S1689 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1681-s1690 — Dataset — dataset versioning: deferred — current CSV exports are point-in-time; no dataset_versions table. | deferred |
| S1690 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1681-s1690 — Dataset — dataset launch playbook: deferred — gates on S1681-S1689. | deferred |
| S1691 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1691-s1700 — API — /api/v2 route base: deferred — no v2 routes per S1181. | deferred |
| S1692 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1691-s1700 — API — OAuth client / API-key model: deferred — no Sanctum / Passport install per S1182. | deferred |
| S1693 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1691-s1700 — API — academic-tier signup: deferred — depends on S1692. | deferred |
| S1694 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1691-s1700 — API — academic-tier rate limit (higher than free tier): deferred — depends on S1691 + S1692; surrogate is per-IP RateLimiter on advertiser-lead endpoint (AdvertiserLeadController 5/10min). | deferred |
...
| S1700 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1691-s1700 — API — academic-tier launch playbook: deferred — gates on S1691-S1699. | deferred |
| S1701 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1701-s1710 — Vector store — infra pick (pgvector / qdrant / pinecone / weaviate): deferred — same as S1076. | deferred |
| S1702 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1701-s1710 — Vector store — schema (post_embeddings table with vector(N) column): deferred — depends on S1701. | deferred |
| S1703 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1701-s1710 — Vector store — embedding-generation pipeline: deferred — depends on S1701 + external embedding model. | deferred |
| S1704 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1701-s1710 — Vector store — daily backfill cron: deferred — depends on S1703. | deferred |
| S1705 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1701-s1710 — Vector store — incremental update on new post: deferred — depends on S1703. | deferred |
| S1706 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1701-s1710 — Vector store — semantic search query handler: deferred — same as S1471 semantic-search row (which honestly defers). | deferred |
...
| S1709 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1701-s1710 — Vector store — cost dashboard: deferred — depends on S1701 + S1703. | deferred |
| S1710 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1701-s1710 — Vector store — launch playbook: deferred — gates on S1701-S1709. | deferred |
...
| S1713 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1711-s1720 — Feature store — daily snapshot job: deferred — depends on S1711 + S1712. | deferred |
| S1714 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1711-s1720 — Feature store — point-in-time consistency: deferred — depends on S1713. | deferred |
| S1715 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1711-s1720 — Feature store — feature-versioning: deferred — git history is the version pin today (same shape as S1074 prompt-version pinning). | deferred |
| S1716 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1711-s1720 — Feature store — feature-discovery UI: deferred — same. | deferred |
| S1717 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1711-s1720 — Feature store — offline / online parity tests: deferred — same. | deferred |
| S1718 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1711-s1720 — Feature store — feature-store paper / methodology: deferred — depends on S1711-S1717 actually shipping. | deferred |
| S1719 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1711-s1720 — Feature store — feature-store cost dashboard: deferred — same. | deferred |
| S1720 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1711-s1720 — Feature store — launch playbook: deferred — gates on S1711-S1719. | deferred |
| S1721 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1721-s1730 — A/B harness — experiment-registry schema: deferred — no experiments / experiment_assignments tables. | deferred |
| S1722 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1721-s1730 — A/B harness — traffic-splitter middleware: deferred — depends on S1721. | deferred |
| S1723 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1721-s1730 — A/B harness — variant render hook in Blade: deferred — depends on S1722. | deferred |
| S1724 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1721-s1730 — A/B harness — assignment cookie: deferred — depends on S1721; cookie-shape proven by existing grimba_region / grimba_local_* cookies. | deferred |
...
| S1726 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1721-s1730 — A/B harness — sequential testing / stop-early stats: deferred — depends on S1721-S1725. | deferred |
| S1727 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1721-s1730 — A/B harness — admin experiment console: deferred — same. | deferred |
| S1728 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1721-s1730 — A/B harness — feature-flag rollout (per-cohort): deferred — same. | deferred |
| S1729 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1721-s1730 — A/B harness — experiment retrospective doc template: deferred — same. | deferred |
| S1730 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1721-s1730 — A/B harness — launch playbook: deferred — gates on S1721-S1729. | deferred |
| S1731 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1731-s1740 — Warehouse — destination pick (BigQuery / Snowflake / DuckDB / ClickHouse): deferred — no warehouse provisioned. | deferred |
...
| S1734 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1731-s1740 — Warehouse — source dwell-time capture: deferred — no client-side dwell-time beacon; surrogate is per-article presence in grimba_read cookie. | deferred |
...
| S1737 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1731-s1740 — Warehouse — dashboard layer (Metabase / Looker / Hex / Superset): deferred — depends on S1731. | deferred |
...
| S1739 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1731-s1740 — Warehouse — cost dashboard: deferred — depends on S1731. | deferred |
| S1740 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1731-s1740 — Warehouse — launch playbook: deferred — gates on S1731-S1739. | deferred |
...
| S1749 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1741-s1750 — Observability — alerting v2 (Slack / email / PagerDuty webhook): deferred — grimba:health writes to grimba_automation_runs + cockpit board; external alert webhook deferred per S1014 / S1019. | deferred |
| S1750 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1741-s1750 — Observability — launch playbook: deferred — gates on S1745-S1749. | deferred |
| S1751 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1751-s1760 — Africa edition v2 — named curator role: deferred — operator-side editorial staffing. | deferred |
| S1752 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1751-s1760 — Africa edition v2 — curator admin scope: deferred — Botble admin auth is single-role per S1401. | deferred |
| S1753 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1751-s1760 — Africa edition v2 — translator role: deferred — GrimbaTranslator covers automated FR↔EN via rule engine + LibreTranslate / OpenRouter / DeepL fallback per GrimbaTranslator::configuredDrivers(); human  | deferred |
...
| S1756 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1751-s1760 — Africa edition v2 — Africa ad-ops dashboard: deferred — depends on S1755. | deferred |
| S1757 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1751-s1760 — Africa edition v2 — Africa sponsor inventory: deferred — same. | deferred |
| S1758 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1751-s1760 — Africa edition v2 — Africa newsletter cadence (separate from main): deferred — newsletter_subscriptions table single-edition today. | deferred |
...
| S1760 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1751-s1760 — Africa edition v2 — launch retrospective: deferred — operator-side retro. | deferred |
...
| S1762 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1761-s1770 — International edition v2 — named curator role: deferred — same shape as S1751. | deferred |
| S1763 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1761-s1770 — International edition v2 — curator admin scope: deferred — same shape as S1752. | deferred |
...
| S1767 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1761-s1770 — International edition v2 — International sponsor inventory: deferred — same shape as S1757. | deferred |
| S1768 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1761-s1770 — International edition v2 — International newsletter cadence: deferred — same shape as S1758. | deferred |
...
| S1770 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1761-s1770 — International edition v2 — launch retrospective: deferred — operator-side retro. | deferred |
...
| S1772 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1771-s1780 — Bias-bar tutorial — first-visit overlay modal: deferred — no bias-bar-tutorial-overlay.blade.php partial; surrogate is the explainer page link from the bias-distribution chart caption. | deferred |
| S1773 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1771-s1780 — Bias-bar tutorial — step-through animation (hover-to-explain per segment): deferred — depends on S1772. | deferred |
...
| S1778 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1771-s1780 — Bias-bar tutorial — partner-school distribution: deferred — no partner-school program (gates on S1741-S1750 literacy band). | deferred |
| S1779 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1771-s1780 — Bias-bar tutorial — analytics (completion rate): deferred — no overlay; depends on S1772 + S1733 read-event capture. | deferred |
| S1780 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1771-s1780 — Bias-bar tutorial — launch retrospective: deferred — gates on S1772-S1779. | deferred |
...
| S1787 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1781-s1790 — Fact-check primer — partner-school distribution: deferred — same as S1778. | deferred |
| S1788 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1781-s1790 — Fact-check primer — interactive quiz: deferred — no quiz primitive (gates on S1721-S1730 literacy band). | deferred |
| S1789 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1781-s1790 — Fact-check primer — analytics (read-through rate): deferred — depends on S1733 read-event capture. | deferred |
...
| S1791 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1791-s1800 — Methodology video — script: deferred — no video pipeline; surrogate is /methodologie written longform. | deferred |
...
| S1796 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1791-s1800 — Methodology video — cross-locale subtitles (FR + EN): deferred — depends on S1791-S1795. | deferred |
| S1797 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1791-s1800 — Methodology podcast — recording: deferred — no audio pipeline. | deferred |
| S1798 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1791-s1800 — Methodology podcast — hosting + RSS (Apple Podcasts / Spotify): deferred — operator-side; depends on S1797. | deferred |
| S1799 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1791-s1800 — Methodology podcast — transcript: deferred — depends on S1797. | deferred |
| S1800 | docs/GRIMBANEWS_MYTHOS_S1601_S1800_LOCAL_TOOLS_DATA_EVIDENCE.md#s1791-s1800 — Methodology video / podcast launch retrospective: deferred — gates on S1791-S1799. | deferred |
...
| S1810 | docs/GRIMBANEWS_MYTHOS_S1801_S2000_COMPLIANCE_INFRA_EVIDENCE.md#s1801-s1810 — SOC 2 Type I prep retrospective: deferred — gates on S1801-S1809 actually shipping; operator-side Sara-Chen retro. | deferred |
| S1811 | docs/GRIMBANEWS_MYTHOS_S1801_S2000_COMPLIANCE_INFRA_EVIDENCE.md#s1811-s1820 — SOC 2 audit firm engagement: deferred — no signed engagement; budget + firm-shortlist Sara-Chen-owned. | deferred |
...
| S1873 | docs/GRIMBANEWS_MYTHOS_S1801_S2000_COMPLIANCE_INFRA_EVIDENCE.md#s1871-s1880 — Vendor DPA collection: deferred — no DPA register; operator-side counsel pickup. | deferred |
...
| S1888 | docs/GRIMBANEWS_MYTHOS_S1801_S2000_COMPLIANCE_INFRA_EVIDENCE.md#s1881-s1890 — Internal-audit independence safeguards: deferred — same. | deferred |
...
| S1951 | docs/GRIMBANEWS_MYTHOS_S1801_S2000_COMPLIANCE_INFRA_EVIDENCE.md#s1951-s1960 — Referral program design (referrer reward / referee reward): deferred — Lucy-Leai-Strategy + Ray-CFO pickup. | deferred |
| S1952 | docs/GRIMBANEWS_MYTHOS_S1801_S2000_COMPLIANCE_INFRA_EVIDENCE.md#s1951-s1960 — Referral code generation: deferred — no members.referral_code column. | deferred |
| S1953 | docs/GRIMBANEWS_MYTHOS_S1801_S2000_COMPLIANCE_INFRA_EVIDENCE.md#s1951-s1960 — Referral attribution tracking: deferred — same. | deferred |
...
| S1955 | docs/GRIMBANEWS_MYTHOS_S1801_S2000_COMPLIANCE_INFRA_EVIDENCE.md#s1951-s1960 — Referral fraud detection: deferred — depends on S1951-S1954. | deferred |
...
| S1957 | docs/GRIMBANEWS_MYTHOS_S1801_S2000_COMPLIANCE_INFRA_EVIDENCE.md#s1951-s1960 — Referral dashboard (per-member): deferred — same. | deferred |
| S1958 | docs/GRIMBANEWS_MYTHOS_S1801_S2000_COMPLIANCE_INFRA_EVIDENCE.md#s1951-s1960 — Referral leaderboard: deferred — same. | deferred |
...
| S1961 | docs/GRIMBANEWS_MYTHOS_S1801_S2000_COMPLIANCE_INFRA_EVIDENCE.md#s1961-s1970 — Partner program tier design (free RSS / paid API / co-brand): deferred — Lucy-Leai-Strategy + Ray-CFO pickup. | deferred |
| S1962 | docs/GRIMBANEWS_MYTHOS_S1801_S2000_COMPLIANCE_INFRA_EVIDENCE.md#s1961-s1970 — Partner onboarding flow: deferred — same. | deferred |
| S1963 | docs/GRIMBANEWS_MYTHOS_S1801_S2000_COMPLIANCE_INFRA_EVIDENCE.md#s1961-s1970 — Partner portal: deferred — same. | deferred |
...
| S1967 | docs/GRIMBANEWS_MYTHOS_S1801_S2000_COMPLIANCE_INFRA_EVIDENCE.md#s1961-s1970 — Partner analytics dashboard: deferred — depends on S1188 API analytics band. | deferred |
| S1968 | docs/GRIMBANEWS_MYTHOS_S1801_S2000_COMPLIANCE_INFRA_EVIDENCE.md#s1961-s1970 — Partner case studies: deferred — gates on ≥1 real partner. | deferred |
...
| S1981 | docs/GRIMBANEWS_MYTHOS_S1801_S2000_COMPLIANCE_INFRA_EVIDENCE.md#s1981-s1990 — Institutional license tier design (per-seat vs site-wide): deferred — Ray-CFO + Lucy-Strategy pickup. | deferred |
...
| S1985 | docs/GRIMBANEWS_MYTHOS_S1801_S2000_COMPLIANCE_INFRA_EVIDENCE.md#s1981-s1990 — Institutional license per-institution analytics: deferred — depends on S1188 API analytics band. | deferred |
...
| S1988 | docs/GRIMBANEWS_MYTHOS_S1801_S2000_COMPLIANCE_INFRA_EVIDENCE.md#s1981-s1990 — Institutional license renewal cadence: deferred — gates on ≥1 real institutional customer. | deferred |
...
| S1991 | docs/GRIMBANEWS_MYTHOS_S1801_S2000_COMPLIANCE_INFRA_EVIDENCE.md#s1991-s2000 — Enterprise tier feature design (SLA, dedicated support, custom features): deferred — Ray-CFO + Lucy-Strategy + Sara-Chen pickup. | deferred |
...
| S1993 | docs/GRIMBANEWS_MYTHOS_S1801_S2000_COMPLIANCE_INFRA_EVIDENCE.md#s1991-s2000 — Enterprise tier dedicated-support tier (CSM, response-time tiers): deferred — depends on staffing decision. | deferred |
...
| S1998 | docs/GRIMBANEWS_MYTHOS_S1801_S2000_COMPLIANCE_INFRA_EVIDENCE.md#s1991-s2000 — Enterprise tier customer-success motion: deferred — gates on ≥1 real enterprise customer. | deferred |
