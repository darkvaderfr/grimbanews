...
| BACKFILL-CAT-1 | Per-editorial-category 500+ article backfill | 90m | shipped 2026-05-16 — `grimba:backfill-category --target=500 [--window=90] [--max-runs-per-category=8] [--category=NAME] [--dry-run]`. Live state 2026-05-17 after Wave EE backfill + Wave II Immigration seed + RSS re-poll: À la une 800✓, Géopolitique 577✓; **needs backfill:** Politique 449/500, Culture 319/500, Tech 267/500, Économie 243/500, Justice 184/500, Climat 130/500, Sports 122/500, Sciences 122/500, Santé 112/500, Société 110/500, Monde 87/500, Immigration 73/500 (up from 0 — Wave II classifier rule + RSS seed). Operator queue: re-run after adding more francophone Immigration RSS feeds. |
