...
class NewsApiSourceBiasSeeder extends Seeder
{
    ...
    private function catalog(): array
    {
        return [
            ...
            ['api_id' => null,           'name' => 'Global News',  'website' => 'globalnews.ca',  'bias' => 'center', 'ownership' => 'corporate',   'credibility' => 76, 'country' => 'CA', 'language' => 'en', 'description' => 'Canadian national and local news network owned by Corus Entertainment.'],
