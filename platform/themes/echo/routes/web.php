...
Route::group(['middleware' => ['web', 'core']], function (): void {
    Theme::registerRoutes(function (): void {
        ...
        Route::get('comparatif/{clusterId}', function (int $clusterId) {
            ...
            // Wave LLLLLL (Vader 2026-05-19) — dossier-specific OG image.
            // Each cluster has its own /og/story/{id}.png generated by
            // the OG image controller. Without this, every cluster
            // unfurled with the generic /og/home.png — losing the
            // per-story SEO + social signal. og:type=article also
            // matches the page role (single story, multi-source view).
            Theme::set('grimba_og_image', url('/og/story/' . $clusterId . '.png'));
            \Botble\SeoHelper\Facades\SeoHelper::openGraph()->setType('article');
