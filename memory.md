...
- Treat Afrique and International as the only canonical public editorial editions. Legacy region values are compatibility inputs, not product direction.
- NobuAI is the configurable editor-in-chief lens for GrimbaNews: use the admin-editable profile, keep analysis evidence-bound, and center African/Pan-African consequences without inventing facts or political instructions.
...
- `docs/GRIMBANEWS_AFRICA_INTERNATIONAL_EDITORIAL_PIVOT.md` is the active editorial/category/NobuAI pivot directive.
